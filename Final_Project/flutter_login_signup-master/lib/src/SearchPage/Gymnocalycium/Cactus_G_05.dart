...
class OchoterenaePage extends StatefulWidget {
  @override
  _OchoterenaepageState createState() => _OchoterenaepageState();
}

class _OchoterenaepageState extends State<OchoterenaePage> {
  String value = 'Gymnocalycium';
  String value2 = 'Ochoterenae';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Gymnocalyium/Ochoterenae.jpg',
        height: 250,
        width: 250,
      ),
    );
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          // ),
          Text(
            'เป็นยิมโนพันธุ์ที่น่าสนใจตรงที่หนามสามแฉกแบนราบกับลำต้น มักอยู่ต้นเดี่ยวๆ ไม่ค่อยแจกหน่อ ลำค้นจะเปลี่ยนเป็นสีม่วงเมื่อเลี้ยงกับแสงแดดแรง ชอบกระถางที่ใหญ่กว่าตัวมันเล็กน้อยเนื่องจากมีรากที่กระจายออกข้างดี',
            overflow: TextOverflow.visible,
            style: TextStyle(color: Colors.black, fontSize: 18),
          ),
        ],
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Gymnocalycium Ochoterenae'),
                  ),
                ),
              ),
            ],
