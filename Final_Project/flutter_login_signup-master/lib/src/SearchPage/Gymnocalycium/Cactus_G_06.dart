...
class SpegazziniiPage extends StatefulWidget {
  @override
  _SpegazziniipageState createState() => _SpegazziniipageState();
}

class _SpegazziniipageState extends State<SpegazziniiPage> {
  String value = 'Gymnocalycium';
  String value2 = 'Spegazzinii';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Gymnocalyium/Spegazzinii.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'ในธรรมชาติมักอยู่ในทรายที่อุ้มน้ำ ดูแลง่ายแต่โตช้าและไม่ค่อยแตกหน่อ บางครั้งมีปัญหาเรื่องแมลงกัดกินควรวางในที่ไม่มีแมลง',
          ...
          Text(
            'กระบองเพชรตระกูล Gymnocalycium เป็นไม่เนื้อแข็ง ทนแดดและทนน้ำได้ดี แต่ควรมีการพรางแสงบ้างเพื่อให้มีผิวที่สวย ศัตรูสำคัญคือเพลี้ยต่างๆ ซึ่งควรจะคอยสังเกตและคอยโรยยาฆ่าแมลงแบบเกล็ดเพื่อป้องกัน'
            'กระบองเพชรตระกูลนี้มักออกดอกช่วงต้นถึงกลางฤดูร้อนไทย',
            overflow: TextOverflow.visible,
            style: TextStyle(color: Colors.black, fontSize: 18),
          ),
        ],
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('ymnocalycium Spegazzinii'),
                  ),
                ),
              ),
            ],
