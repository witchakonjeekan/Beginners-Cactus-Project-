...
class MihanovichiiPage extends StatefulWidget {
  @override
  _MihanovichiipageState createState() => _MihanovichiipageState();
}

class _MihanovichiipageState extends State<MihanovichiiPage> {

  String value = 'Gymnocalycium';
  String value2 = 'Mihanovichii';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Gymnocalyium/mihanovichii.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นสายพันธุ์ของกระบองเพชรจากอเมริกาใต้ สายพันธุ์ที่ได้รับความนิยมมากที่สุดคือการกลายพันธุ์ที่หลากหลายซึ่งขาดคลอโรฟิลล์อย่างสมบูรณ์เผยให้เห็นผิวคล้ำสีแดงสีส้มหรือสีเหลือง สายพันธุ์กลายพันธุ์เหล่านี้มักจะต่อกิ่ง',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Gymnocalycium Mihanovichii'),
                  ),
                ),
              ),
            ],
