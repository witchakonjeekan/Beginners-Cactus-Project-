...
class zougemaruPage extends StatefulWidget {
  @override
  _zougemarupageState createState() => _zougemarupageState();
}

class _zougemarupageState extends State<zougemaruPage> {

  String value = 'Coryphantha';
  String value2 = 'Zougemaru';
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Coryphantha zougemaru'),
                  ),
                ),
              ),
            ],
