...
class elephantidensPage extends StatefulWidget {
  @override
  _elephantidenspageState createState() => _elephantidenspageState();
}

class _elephantidenspageState extends State<elephantidensPage> {

  String value = 'Coryphantha';
  String value2 = 'Elephantidens';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/coryphantha/elephantidens.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นแคคตัสสายพันธุ์ขนาดใหญ่ ต้นโตเต็มไวัยมีขนาดมากกว่า 18 ซม. รูปร่างทรงกลม'
            'แตกหน่อได้จำนวนมากเมื่อขนาดโตเต็มวัย โขดนาดใหญ่ หนามสั้น ดอกมีกลิ่นหอม'
            '',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Coryphantha elephantidens'),
                  ),
                ),
              ),
            ],
