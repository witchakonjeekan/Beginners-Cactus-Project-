...
class retusaPage extends StatefulWidget {
  @override
  _retusapageState createState() => _retusapageState();
}

class _retusapageState extends State<retusaPage> {

  String value = 'Coryphantha';
  String value2 = 'Retusa';
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            ...
            'แตกหน่อได้จำนวนมากเมื่อขนาดโตเต็มวัย โขดนาดใหญ่ หนามค่อนข้างยาว ดอกมีกลิ่นหอม'
            '',
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      // _iconWater(),
                      Center (
                        child: Text('รดน้ำได้ประมาน 1-2 วันครั้ง'),
                      ),
                    ],
                  ),
                ),
