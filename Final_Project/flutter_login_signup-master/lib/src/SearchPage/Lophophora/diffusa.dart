...
class diffusaPage extends StatefulWidget {
  @override
  _diffusapageState createState() => _diffusapageState();
}

class _diffusapageState extends State<diffusaPage> {

  String value = 'Lophophora';
  String value2 = 'Diffusa';
