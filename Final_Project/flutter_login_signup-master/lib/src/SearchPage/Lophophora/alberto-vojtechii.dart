...
class albertovojtechiiPage extends StatefulWidget {
  @override
  _albertovojtechiipageState createState() => _albertovojtechiipageState();
}

class _albertovojtechiipageState extends State<albertovojtechiiPage> {

  String value = 'Lophophora';
  String value2 = 'Alberto vojtechii';
  Widget _HeaderName() {
    return Container(
      child: Column(
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Lophophora/albertovojtechii01.jpg',
        height: 250,
        width: 250,
      ),
    );
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Lophophora alberto vojtechii'),
                  ),
                ),
              ),
            ],
