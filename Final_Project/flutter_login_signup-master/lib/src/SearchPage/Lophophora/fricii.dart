...
class friciiPage extends StatefulWidget {
  @override
  _friciipageState createState() => _friciipageState();
}

class _friciipageState extends State<friciiPage> {

  String value = 'Lophophora';
  String value2 = 'Fricii';
  Widget _HeaderName() {
    return Container(
      child: Column(
