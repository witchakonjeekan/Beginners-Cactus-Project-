...
class ShowDataModel extends StatefulWidget {
  final String value;
  const ShowDataModel({Key key, this.value}) : super(key: key);

  @override
  _ShowDataModelState createState() => _ShowDataModelState();
}

class _ShowDataModelState extends State<ShowDataModel> {
  String value;
