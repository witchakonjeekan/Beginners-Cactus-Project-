...
class capricornePage extends StatefulWidget {
  @override
  _capricornepageState createState() => _capricornepageState();
}

class _capricornepageState extends State<capricornePage> {

  String value = 'Astrophytum';
  String value2 = 'Capricorne';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Astrophytum/capricorne.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'คล้ายกับ Astrophytum ทั่วไปแต่หนามจะแตกต่างจากสายพันธุ์อื่น'
            'หนานของสายพันธุ์นี้จะมีรูปร่างโค้งไปมาแล้วยาว'
            '',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Astrophytum capricorne'),
                  ),
                ),
              ),
            ],
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('สีขาว สีเหลือง สีแดง'),
                  ),
                ),
              ),
            ],
