...
class BucareliensisPage extends StatefulWidget {
  @override
  _BucareliensispageState createState() => _BucareliensispageState();
}

class _BucareliensispageState extends State<BucareliensisPage> {
  String value = 'Mammillaria';
  String value2 = 'Bucareliensis';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Mammillaria/Bucareliensis.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นแคคตัสสายพันธุ์ที่มีขนาดเล็ก ชอบอยู่เป็นต้นเดี่ยวในช่วงแรกแต่เมื่ออายุมากขึ้นจะแตกหน่อเป็นกอ'
            'ลำต้นสีเขียว ก้านชูยิ่งยาวออกจากลำต้นเมื่อถึงระยะเวลาที่จะออกดอกจะมีขน ปุยสีขาวรอบลำต้น'
            '',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria Bucareliensis'),
                  ),
                ),
              ),
            ],
