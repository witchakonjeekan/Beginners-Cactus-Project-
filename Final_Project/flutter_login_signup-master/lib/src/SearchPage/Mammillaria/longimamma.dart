...
class longimammaPage extends StatefulWidget {
  @override
  _longimammapageState createState() => _longimammapageState();
}

class _longimammapageState extends State<longimammaPage> {
  String value = 'Mammillaria';
  String value2 = 'Longimamma';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Mammillaria/longimamma.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นสายพันธุ์ที่ชอบอยู่โดดเดี่ยวในตอนแรกๆ หลังจากนั้นจะแตกหน่อ ลำต้นสีเขียวรุปทรงเกลียว เติบโตง่าย',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria longimamma'),
                  ),
                ),
              ),
            ],
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      // _iconWater(),
                      Center (
                        child: Text('ควรรดน้ำให้ความถี่น้อยกว่าสายพันธุ์อื่น'),
                      ),
                    ],
                  ),
                ),
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  ...
                  child: Center(
                    child: Text(
                        'สามารถอยู่ได้ทั้งที่พรางแสงหรือร่มรำไร หรือแดดตรงอย่างน้อยครึ่งวัน'),
                  ),
                ),
              ),
            ],
