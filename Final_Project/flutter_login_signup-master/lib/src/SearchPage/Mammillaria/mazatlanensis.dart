...
class mazatlanensisPage extends StatefulWidget {
  @override
  _mazatlanensispageState createState() => _mazatlanensispageState();
}

class _mazatlanensispageState extends State<mazatlanensisPage> {
  String value = 'Mammillaria';
  String value2 = 'Mazatlanensis';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Mammillaria/mazatlanensis.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นสายพันธุ์ที่ชอบอยู่โดดเดี่ยว ในช่วงที่มีอายุมาก ลำต้นจะสูงยาว ทรงกระบอก มีดอกสีชมพูสวย',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria mazatlanensis'),
                  ),
                ),
              ),
            ],
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Center(
                        child:
                            Text('รดน้ำเมื่อดินแห้ง ปกติประมาน 3-7 วันครั้ง'),
                      ),
                    ],
                  ),
                ),
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  ...
                  child: Center(
                    child: Text(
                        'ชอบแดดทั้งวัน แต่ควรมีการพรางแสงบ้าง ให้ได้รับแดดประมาน 80%'),
                  ),
                ),
              ),
            ],
