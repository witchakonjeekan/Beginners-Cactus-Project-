...
class albicomaPage extends StatefulWidget {
  @override
  _albicomapageState createState() => _albicomapageState();
}

class _albicomapageState extends State<albicomaPage> {
  String value = 'Mammillaria';
  String value2 = 'Albicoma';
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นแคคตัสสายพันธุ์ที่มีขนาดเล็ก มักจะอยู่เป็นต้นเดี่ยวหรือแตกกิ่งช้า มีดอกที่สวยงามมาก'
            'ลำต้นทรงกลม ไม่มีหนาม แล้วจะมีขดสีขาวๆที่ดูแล้วสวยมาก'
            '',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria albicoma'),
                  ),
                ),
              ),
            ],
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('สีขาว สีเหลือง สีชมพู'),
                  ),
                ),
              ),
            ],
