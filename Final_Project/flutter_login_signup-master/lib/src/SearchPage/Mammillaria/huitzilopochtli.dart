...
class huitzilopochtliPage extends StatefulWidget {
  @override
  _huitzilopochtlipageState createState() => _huitzilopochtlipageState();
}

class _huitzilopochtlipageState extends State<huitzilopochtliPage> {
  String value = 'Mammillaria';
  String value2 = 'Huitzilopochtli';
  ...
  Widget _Imagecactus() {
    return Container(
      child: Image.asset(
        'img/Mammillaria/huitzilopochtli.jpg',
        height: 250,
        width: 250,
      ),
    );
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'เป็นแคคตัสสายพันธุ์ที่มีขนาดเล็ก มักจะอยู่กันเป็นกลุ่ม แต่พบว่าเมื่อายุมากจะมีการแตกหน่อ ลำต้นสีเขียวเข้ม ผิวอ่อนนุ่ม จะพบว่ามีขนสีขาวบริเวณที่จะออกจากดอก',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria huitzilopochtli'),
                  ),
                ),
              ),
            ],
