...
class BeneckeiPage extends StatefulWidget {
  @override
  _BeneckeipageState createState() => _BeneckeipageState();
}

class _BeneckeipageState extends State<BeneckeiPage> {
  String value = 'Mammillaria';
  String value2 = 'Beneckei';
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            ...
            'ลำต้นทรงกลม มีหนาม2แบบในลำต้นเดียวกัน'
            '',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria Beneckei'),
                  ),
                ),
              ),
            ],
