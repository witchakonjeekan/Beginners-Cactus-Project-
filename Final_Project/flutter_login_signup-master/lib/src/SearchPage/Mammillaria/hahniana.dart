...
class hahnianaPage extends StatefulWidget {
  @override
  _hahnianapageState createState() => _hahnianapageState();
}

class _hahnianapageState extends State<hahnianaPage> {
  String value = 'Mammillaria';
  String value2 = 'Hahniana';
  ...
  Widget _Storytext() {
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text(
            'ชอบแสงมาก และมักอยู่รวมกันเป็นกลุ่ม ขนสีขาว เมื่อยังเล็กๆจะเป็นทรงกลม หลักจากนั้นเมื่อโตขึ้นจะเริ่มเป็นทรงกระบอก ลำต้นเมื่อตัดมียางสีขาว ผลของต้นสามารถรับประทานได้',
            ...
            children: [
              ...
              TableCell(
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Center(
                    child: Text('Mammillaria hahniana'),
                  ),
                ),
              ),
            ],
